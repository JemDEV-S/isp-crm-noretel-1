...
@section('title', 'Nueva Política de Seguridad')

@section('page-title', 'Nueva Política de Seguridad')

@section('content')
<div class="card">
    <div class="card-header">
        <h5 class="mb-0">Crear Política de Seguridad</h5>
    </div>
    <div class="card-body">
        <form action="{{ route('core.security.store') }}" method="POST" id="policyForm">
            @csrf
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select @error('policy_type') is-invalid @enderror" id="policy_type" name="policy_type" required>
                        ...
                        @foreach($policyTypes as $value => $label)
                            <option value="{{ $value }}" {{ old('policy_type') == $value ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                    @error('policy_type')
                        <div class="invalid-feedback">{{ $message }}</div>
            ...
            <div id="password-config" class="policy-config" style="display: none;">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control @error('configuration.min_length') is-invalid @enderror" id="config_min_length" name="configuration[min_length]" value="{{ old('configuration.min_length', 8) }}" min="6" max="30">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control @error('configuration.password_history') is-invalid @enderror" id="config_password_history" name="configuration[password_history]" value="{{ old('configuration.password_history', 3) }}" min="0" max="24">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control @error('configuration.expire_days') is-invalid @enderror" id="config_expire_days" name="configuration[expire_days]" value="{{ old('configuration.expire_days', 90) }}" min="0" max="365">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="config_require_numbers" name="configuration[require_numbers]" value="1" {{ old('configuration.require_numbers', 1) ? 'checked' : '' }}>
                            <label class="form-check-label" for="config_require_numbers">
                                Requerir números
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="config_require_uppercase" name="configuration[require_uppercase]" value="1" {{ old('configuration.require_uppercase', 1) ? 'checked' : '' }}>
                    ...
                    <div class="col-md-6">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="config_require_lowercase" name="configuration[require_lowercase]" value="1" {{ old('configuration.require_lowercase', 1) ? 'checked' : '' }}>
                            <label class="form-check-label" for="config_require_lowercase">
                                Requerir minúsculas
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="config_require_special" name="configuration[require_special]" value="1" {{ old('configuration.require_special', 1) ? 'checked' : '' }}>
            ...
            <div id="login-config" class="policy-config" style="display: none;">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control @error('configuration.max_attempts') is-invalid @enderror" id="config_max_attempts" name="configuration[max_attempts]" value="{{ old('configuration.max_attempts', 5) }}" min="1" max="10">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control @error('configuration.lockout_minutes') is-invalid @enderror" id="config_lockout_minutes" name="configuration[lockout_minutes]" value="{{ old('configuration.lockout_minutes', 15) }}" min="1" max="1440">
                ...
                <div class="mb-3">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="config_require_2fa" name="configuration[require_2fa]" value="1" {{ old('configuration.require_2fa', 0) ? 'checked' : '' }}>
                        <label class="form-check-label" for="config_require_2fa">
                            Requerir autenticación de dos factores
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="config_allow_remember_me" name="configuration[allow_remember_me]" value="1" {{ old('configuration.allow_remember_me', 1) ? 'checked' : '' }}>
            ...
            <div id="account_lockout-config" class="policy-config" style="display: none;">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control @error('configuration.auto_lockout_days') is-invalid @enderror" id="config_auto_lockout_days" name="configuration[auto_lockout_days]" value="{{ old('configuration.auto_lockout_days', 90) }}" min="0" max="365">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control @error('configuration.inactive_warning_days') is-invalid @enderror" id="config_inactive_warning_days" name="configuration[inactive_warning_days]" value="{{ old('configuration.inactive_warning_days', 7) }}" min="0" max="30">
                ...
                <div class="mb-3">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="config_send_warning_email" name="configuration[send_warning_email]" value="1" {{ old('configuration.send_warning_email', 1) ? 'checked' : '' }}>
            ...
            <div id="session-config" class="policy-config" style="display: none;">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control @error('configuration.timeout_minutes') is-invalid @enderror" id="config_timeout_minutes" name="configuration[timeout_minutes]" value="{{ old('configuration.timeout_minutes', 30) }}" min="1" max="1440">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control @error('configuration.absolute_timeout_hours') is-invalid @enderror" id="config_absolute_timeout_hours" name="configuration[absolute_timeout_hours]" value="{{ old('configuration.absolute_timeout_hours', 8) }}" min="1" max="168">
                ...
                <div class="mb-3">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="config_refresh_on_activity" name="configuration[refresh_on_activity]" value="1" {{ old('configuration.refresh_on_activity', 1) ? 'checked' : '' }}>
                        <label class="form-check-label" for="config_refresh_on_activity">
                            Refrescar tiempo de inactividad con actividad del usuario
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="config_single_session" name="configuration[single_session]" value="1" {{ old('configuration.single_session', 0) ? 'checked' : '' }}>
            ...
            <div id="api-config" class="policy-config" style="display: none;">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control @error('configuration.token_expiry_days') is-invalid @enderror" id="config_token_expiry_days" name="configuration[token_expiry_days]" value="{{ old('configuration.token_expiry_days', 30) }}" min="1" max="365">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control @error('configuration.rate_limit_per_minute') is-invalid @enderror" id="config_rate_limit_per_minute" name="configuration[rate_limit_per_minute]" value="{{ old('configuration.rate_limit_per_minute', 60) }}" min="1" max="1000">
                ...
                <div class="mb-3">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="config_require_https" name="configuration[require_https]" value="1" {{ old('configuration.require_https', 1) ? 'checked' : '' }}>
            ...
            <div id="file_upload-config" class="policy-config" style="display: none;">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control @error('configuration.max_size_kb') is-invalid @enderror" id="config_max_size_kb" name="configuration[max_size_kb]" value="{{ old('configuration.max_size_kb', 10240) }}" min="1" max="102400">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('configuration.allowed_extensions') is-invalid @enderror" id="config_allowed_extensions" name="configuration[allowed_extensions]" value="{{ old('configuration.allowed_extensions', 'jpg,jpeg,png,pdf,doc,docx,xls,xlsx,zip') }}">
                ...
                <div class="mb-3">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="config_scan_for_malware" name="configuration[scan_for_malware]" value="1" {{ old('configuration.scan_for_malware', 1) ? 'checked' : '' }}>
