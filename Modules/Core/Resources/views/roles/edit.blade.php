            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    <div class="form-check form-switch mt-4">
                        <input class="form-check-input @error('active') is-invalid @enderror" type="checkbox" role="switch" id="active" name="active" value="1" {{ old('active', $role->active) ? 'checked' : '' }}>
                                        ...
                                        <div class="row">
                                            @foreach($module['actions'] as $actionKey => $actionName)
                                                <div class="col-md-4 mb-2">
                                                    <div class="form-check">
                                                        <input class="form-check-input permission-checkbox" type="checkbox" name="permissions[]" value="{{ $moduleKey }}|{{ $actionKey }}" id="permission_{{ $moduleKey }}_{{ $actionKey }}" data-module="{{ $moduleKey }}" 
                                                            {{ (old('permissions') && in_array("$moduleKey|$actionKey", old('permissions'))) || 
                                                               (!old('permissions') && isset($currentPermissions["$moduleKey|$actionKey"])) ? 'checked' : '' }}>
